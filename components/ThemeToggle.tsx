...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      ...
      <Moon className="absolute h-[1.2rem] w-[1.2rem] rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100 text-slate-800 dark:text-slate-200" style={{ marginTop: '-1.2rem' }} />
    </button>
  );
}
