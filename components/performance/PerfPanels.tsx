...
import type { PerfQuery } from "./types";

export function PageTitle({ fileCount }: { fileCount: number }) {
  return (
    <div>
...
export function LegendBar({ analyses }: { analyses: HarAnalysis[] }) {
...
export function KpiMatrix({ analyses }: { analyses: HarAnalysis[] }) {
  const stats = useMemo(
...
export function TimingPhaseComparison({ analyses }: { analyses: HarAnalysis[] }) {
  const data = useMemo(
...
export function ContentTypePerf({ analyses }: { analyses: HarAnalysis[] }) {
...
export function CombinedTopN({ analyses }: { analyses: HarAnalysis[] }) {
