...
import type { DiffQuery } from "./types";
...
export function KpiDeltaTable({ base, cmp }: { base: HarAnalysis; cmp: HarAnalysis }) {
...
export function TimingPhaseDelta({
  base,
  cmp,
}: {
  base: HarAnalysis;
...
export function ContentTypeDeltaSection({
  base,
  cmp,
}: {
  base: HarAnalysis;
