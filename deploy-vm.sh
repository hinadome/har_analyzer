...
if [[ "${1:-}" == "--update" ]]; then
  ...
  echo "  Content diff: /content-diff — Selected path; no body vs binary badges; no duplicate-key console errors."
...
echo "  Content:    /content-diff — Selected path; no body (missing text) vs binary MIME badges."
